...
chunk (runtime: main) output.js (main) 2.86 MiB (javascript) 1.58 KiB (runtime) [entry] [rendered]
  > ./example.js main
  dependent modules 2.86 MiB [dependent] 1202 modules
...
chunk (runtime: main) output.js (main) 1.91 MiB (javascript) 1.58 KiB (runtime) [entry] [rendered]
  > ./example.js main
  dependent modules 1.15 MiB [dependent] 583 modules
  runtime modules 1.58 KiB 7 modules
  ./example.js + 613 modules 779 KiB [built] [code generated]
    [no exports]
    [no exports used]
    entry ./example.js main
...
webpack 5.10.0 compiled with 3 warnings
```
